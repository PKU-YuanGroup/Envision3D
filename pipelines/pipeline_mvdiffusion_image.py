...
class MVDiffusionImagePipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        image_embeddings, image_latents = self._encode_image(image_pil, device, num_images_per_prompt,
        ...
        if normal_cond is not None:
            ...
            _, image_latents = self._encode_image(normal_cond_pil, device, num_images_per_prompt,
                                                  do_classifier_free_guidance)
